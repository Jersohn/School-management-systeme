...
class MarksController extends Controller
{
	...
	public function MarksEditGetStudents(Request $request)
	{
		...
		$getStudent = StudentMarks::with(['student'])->where('year_id', $year_id)->where('class_id', $class_id)->where('subject_id', $subject_id)->where('exam_type_id', $exam_type_id)->get();
	...
	public function MarksUpdate(Request $request)
	{
		...
		StudentMarks::where('year_id', $request->year_id)->where('class_id', $request->class_id)->where('subject_id', $request->subject_id)->where('exam_type_id', $request->exam_type_id)->delete();
