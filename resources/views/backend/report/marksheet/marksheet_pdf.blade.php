  ...
  <div class="row">  <!-- start 1st row -->
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>I.T.A</strong></h4>
  			<h6><strong>Abidjan-Macory</strong></h6>
  			<h5><strong><u><i>Bulletin Academique</i></u></strong></h5>
...
<tbody>
    ...
    @foreach($allMarks as $key => $mark)
        ...
        <tr>
            ...
            @endphp
            <td class="text-center">{{ $grade_name ?? 'N/A' }}</td>
            <td class="text-center">{{ $grade_point ?? 'N/A' }}</td>
        </tr>
    @endforeach
