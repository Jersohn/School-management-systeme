					...
					<div class="box">
						<div class="box-header with-border">
							...
							<a href="{{ route('users.add') }}" style="float: right;"
								class="btn btn-rounded btn-success mb-5"> Ajouter un utilisateur</a>
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>{{ $user->code }}</td>
											<td>
												<a style="border: none;" href="{{ route('users.edit',$user->id) }}"
													class="btn btn-outline-info"><i class="fa fa-edit"></i></a>
												<a style="border: none;" href="{{ route('users.delete',$user->id) }}"
