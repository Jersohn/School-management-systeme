				...
				<div class="col-12">
					<div class="box bb-3 border-primary">
						<div class="box-header">
							<h4 class="box-title"><strong>Frais d'inscription</strong></h4>
						</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<select name="class_id" id="class_id" required="" class="form-control">
												<option value="" selected="" disabled="">Selectionnez une Classe</option>
	...
	$(document).ready(function () {
		$(document).on('click', '#search', function (event) {
			...
			$.ajax({
				...
				beforeSend: function () {
					// You can include any pre-ajax request logic here
				},
